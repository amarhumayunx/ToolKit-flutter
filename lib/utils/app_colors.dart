...
class AppColors {
  static const Color primary = Color(0xFF009A99);   // For buttons/screens
  static const Color appBar = Color(0xFF6CC0B9);    // For AppBar
  static const Color dotActive = primary;
  static const Color dotInactive = Color(0xFFAFAFAF);
